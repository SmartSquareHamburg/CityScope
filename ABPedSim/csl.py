""" file gets called from ALL files:
camera_to_grid_undistort.py (load_config())
single_grids_to_full_grid.py (load_config())
grid_to_changes.py (load_config())
wfst.py (load_config(); get_workshop())
publish_statistics.py (load_config(); get_workshop())

webserver.py (load_config())
"""
...
def load_config() -> dict:
    ...
    config['grid_interpolation'] = int(csl_config['DEFAULT']['grid_interpolation'])

    colortizer_codes = csl_config['DEFAULT']['colortizer_codes']
    colortizer_codes = colortizer_codes.split(",")
    colortizer_codes = [int(code.strip()) for code in colortizer_codes]
    config['colortizer_codes'] = colortizer_codes

    config['colortizer_host'] = csl_config['DEFAULT']['colortizer_host']
    config['colortizer_port'] = int(csl_config['DEFAULT']['colortizer_port'])
    config['colortizer_interval'] = float(csl_config['DEFAULT']['colortizer_interval'])
    ...
    config['dbconnstring'] = csl_config['DEFAULT']['dbconnstring']
